...
We calculated three different BTC moving day closing price averages for this project: 10 days, 20 days, and 50 days. 
...
# Bit_log_biwtd_ret - the biweekly-to-date returns using the closing price at time t and t-14
...
# ema_log_ret_14 - the exponential moving average of the biweekly to date returns. Weighted average using values in range of time t and t-14
...
8. What was the impact of the pandemic and other global macro economic forces such as public debt and unemplooyment rates, on cryptocurrency features?
